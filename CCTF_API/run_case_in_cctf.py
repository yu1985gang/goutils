...
def run_case_in_cctf(CCTF_FQDN, CCTF_USER_NAME,CCTF_PASSWORD,test_product_name,COMMON_TC_PACKAGE_URL,COMMON_TC_DOCKER_IMAGE, \
    ...
    test_parameters="TP_BASE_DOMAIN="+TP_BASE_DOMAIN+ \
    ...
    test.update_package_parameters('Common_Test_Cases', format_test_parameters(test_parameters))
    if NE_TC_PACKAGE_URL.strip() != '' and NE_TC_DOCKER_IMAGE_URL.strip() != '':
        ...
        test.update_package_parameters('Customized_Test_Cases', format_test_parameters(NE_TC_PARAMETERS.strip()))
