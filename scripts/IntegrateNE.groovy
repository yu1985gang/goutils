...
def importPlan() {
    ...
    def planImportApi = "curl -ksX POST ${baseUrl}/execute/plan-import"
    ...
    if (planImportResult != '200') {
        if (planImportResult.contains("Plan with the same name already exists")) {
            echo "plan already exist, skip import"
        } else {
