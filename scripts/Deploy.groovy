...
def createClientIfNotExists(client_id, NOM) {
    ...
    if (!fpClient || !fpClient.clientSecret) {
...
def deployPackage(fp_package_name, access_token, NOM) {
    ...
    if (importHttpCodeResponse == "201") {
        echo "This package is imported successfully"
        return true
    } else if (importHttpCodeResponse == "400") {
        echo "This package was imported already."
        return true
    } else {
