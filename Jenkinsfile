pipeline {
    ...
    parameters {
        ...
        text(name: 'NE_CERTIFICATES',
             defaultValue: '',
             description: '(Optional) If the NE has TLS enabled, this parameter is mandatory and contains the TLS CA certificate of NE which Nokia Network Operations Master needs to trust')
        string(
