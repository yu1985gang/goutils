...
jenkins_api
="http://clab175node01.netact.nsn-rdnet.net/view/FP_SyVe/job/Fast_Pass_SyVe_Pipeline/buildWithParameters"
...
curl_args="${curl_args} http://clab175node01.netact.nsn-rdnet.net/view/FP_SyVe/job/Fast_Pass_SyVe_Pipeline/buildWithParameters"

echo "curl args: ${curl_args}"
eval curl -G "${curl_args}"
